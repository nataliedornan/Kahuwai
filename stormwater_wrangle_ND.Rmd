...
filter years with targeted storm events. DISCHARGE DATA IS FROM 10/25/10-2019!!!!
...
Search for smaller storms ~3inches
...
storm_plot_09 <- ggplot(wailupe_storm_09, aes(time, qpcp)) +
  geom_point() +
  xlab("Date") +
  ylab("Precipitation (inches)")
...
#2013 storm @ 2.8 inches
wailupe_storm_13 <- wailupe_tidy_77 %>%
  filter(date >"2013-11-08",
         date <"2013-11-11")

storm_plot_13 <- ggplot(wailupe_storm_13, aes(time, qpcp)) +
  geom_point() +
  xlab("Date") +
  ylab("Precipitation (inches)")
...
write.csv(wailupe_storm_09, file = "wailupe_storm_20131109_r.csv") 
```
