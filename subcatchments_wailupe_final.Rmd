...
attributes <- read_csv("subcatchments_all.csv") %>% 
  clean_names() %>% 
...
subc$curblen <- 0
subc$width <- 400 #placeholder. width is the longest flow path of precipitation in a subcatchment. These were manually measured in ArcGIS using a measurement tool and capped at 400
